...
public class ExistingUsername_ThisUsernameIsNotAvailable {
...
//	private String expectedResult;
	...
	public void AddUserNameValidationTest() throws InterruptedException{
		...
		driver.findElement(By.xpath(".//input[@id='username']")).sendKeys("raj@pepsi.com");
	...
	//	Select 'authorities' Multiple select box ( Use Name locator to identify the element )
	    ...
	    Thread.sleep(5000);
		System.out.println(driver.findElement(By.xpath(".//div[@style='display: block;'][contains(text(),'This username is not available.')]")).getText());
	//	System.out.println(driver.findElement(By.xpath(".//form[@id='editUserForm']/div[1]/div[1]")).getText());
       
        @SuppressWarnings("unused")
		String expectedResult = "This username is not available.";
