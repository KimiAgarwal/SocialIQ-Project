...
public class Alphanumerics_AdminExe_UserHasBeenCreatedSuccessfully {
	...
	public void AddUserNameValidationTest() throws InterruptedException{
		...
		driver.findElement(By.xpath(".//input[@id='firstName']")).sendKeys("kimie343");
		driver.findElement(By.xpath(".//*[@id='lastName']")).sendKeys("afdf46");
