...
public class NumericNumbers_AdminExe_UserHasBeenCreatedSuccessfully {
	...
	public void AddUserNameValidationTest() throws InterruptedException{
		...
		driver.findElement(By.xpath(".//input[@id='firstName']")).sendKeys("21323565");
		driver.findElement(By.xpath(".//*[@id='lastName']")).sendKeys("46546");
