...
public class Time_Alphanumeric_CategoryHasBeenCreatedSuccessfully {
	@Test
	public void AddUserNameValidationTest() throws InterruptedException{
		...
		driver.findElement(By.id("businessCategoryKPISettings.thresholdResponseTime")).sendKeys("qwer123");
		driver.findElement(By.id("businessCategoryKPISettings.thresholdClosureTime")).sendKeys("asdf123");
		driver.findElement(By.id("businessCategoryKPISettings.thresholdResponseTimeForInternalCollaboration")).sendKeys("zxcv123");
