...
public class ThresholdResponseTimeForInternalCollaborationIsRequired {
	@Test
	public void AddUserNameValidationTest() throws InterruptedException{
		...
		String expectedResult = "Threshold Response Time For Internal Collaboration is required" ;
